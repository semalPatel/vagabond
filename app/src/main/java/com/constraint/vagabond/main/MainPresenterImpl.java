...
public class MainPresenterImpl implements MainContract.presenter, MainContract.GetRecAreasInteractor.OnFinishedListener {

    private MainContract.MainView mainView;
    private MainContract.GetRecAreasInteractor getRecAreasInteractor;

    public MainPresenterImpl(MainContract.MainView mainView, MainContract.GetRecAreasInteractor getRecAreasInteractor){
