...
public class MainActivity extends AppCompatActivity implements MainContract.MainView, SearchView.OnQueryTextListener {
    ...
    private RecyclerViewclickListener recyclerViewclickListener = new RecyclerViewclickListener() {
        ...
        public void onItemClick(RecreationalArea recreationalArea) {
            Toast.makeText(MainActivity.this, recreationalArea.getRecAreaName(), Toast.LENGTH_LONG).show();
        }
    };
    ...
    public void setDataToRecyclerView(List<RecreationalArea> recAreasList) {
        ...
        RecreationalAreaAdapter recreationalAreaAdapter = new RecreationalAreaAdapter(recAreasList, recyclerViewclickListener);
        recyclerView.setAdapter(recreationalAreaAdapter);
    }

    @Override
    public void onResponseFailure(Throwable throwable) {
        Toast.makeText(MainActivity.this, "Error fetching data" + throwable.getMessage(), Toast.LENGTH_LONG).show();
    }
