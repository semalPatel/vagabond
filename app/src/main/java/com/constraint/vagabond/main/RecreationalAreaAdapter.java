...
public class RecreationalAreaAdapter extends RecyclerView.Adapter<RecreationalAreaAdapter.AreaHolder> {

    private List<RecreationalArea> recreationalAreaArrayList;
    private RecyclerViewclickListener recyclerViewclickListener;

    public RecreationalAreaAdapter(List<RecreationalArea> recreationalAreas, RecyclerViewclickListener recyclerViewclickListener){
    ...
    @Override
    public void onBindViewHolder(@NonNull AreaHolder areaHolder, @SuppressLint("RecyclerView") final int i) {
